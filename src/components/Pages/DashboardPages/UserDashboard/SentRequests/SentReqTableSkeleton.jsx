        ...
        <div className="rounded-xl overflow-hidden border">
            ...
            {[...Array(rows)].map((_, index) => (
                ...
                >
                    ...
                    <div className="grid gap-1 text-center font-bold col-span-3">
                    ...
                    {/* timeStamp */}
                    <div className="text-center col-span-6 space-y-1">
                        <div>
                    ...
                    {/* Requested by  */}
                    <div className='text-center col-span-4 grid gap-2'>
