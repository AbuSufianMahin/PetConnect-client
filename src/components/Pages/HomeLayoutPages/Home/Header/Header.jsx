...
const Header = () => {
    return (
        <section className="w-11/12 md:w-10/12 max-w-7xl mx-auto border-2 my-5 xl:my-15 rounded-4xl overflow-hidden shadow-lg">
                    ...
                    <div className='w-9/10 mx-auto xl:flex md:pb-0'>
                        <div className='flex-1 flex items-center justify-center text-center xl:text-start'>
                            <div className='w-11/12'>
                                ...
                                <p className="mt-4 text-sm sm:text-lg md:text-xl text-white/90 max-w-xl mx-auto">
                                    Discover your perfect furry (or finned!) companion. Browse, connect, and adopt with ease on PetConnect.
                                </p>
                            </div>
                        </div>
                        <div className='flex-1 mx-auto md:w-2/3 lg:w-3/5'>
                            <img src={bannerImage} alt="pet group" className='w-full' />
                        </div>
                    </div>
                </div>

                <div className="border absolute left-1/2 bg-muted bottom-0 translate-x-[-50%] translate-y-1/2 flex md:gap-1 lg:gap-2 justify-around items-center px-1 py-2 md:py-3 md:px-2 rounded-xl shadow-lg z-10 h-12 lg:h-14 md:w-2/3 xl:w-1/3">
